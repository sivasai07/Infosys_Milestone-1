...
def login():
    ...
    return rx.box(
        ...
        rx.center(
            rx.box(
                rx.vstack(
                    rx.heading("Welcome Back", size="6", color=text_color),
                    rx.text("Login to access recommendations and saved filters.", color=sub_text),
                    ...
                    rx.hstack(
                        rx.text("New here?", color=sub_text),
                        rx.link("Create an account", href="/register", color="#2563EB"),
                        spacing="2"
                    ),
                    spacing="4"
                ),
